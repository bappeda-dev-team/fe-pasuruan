    ...
    return (
        <div className="flex flex-col gap-2 p-2 w-full">
            <div className="flex items-center gap-2">
                <button
                    className={`flex items-center gap-1 p-2 border ${NamaTagging === "Program Unggulan Walikota" ? 'bg-sky-500 text-white' : 'border-sky-500 text-sky-500'} rounded-lg hover:bg-sky-500 hover:text-white
                        `}
                    onClick={() => setNamaTagging("Program Unggulan Walikota")}
                >
                    <TbCircleCheckFilled />
                    Program Unggulan Walikota
                </button>
                <button
                    className={`flex items-center gap-1 p-2 border ${NamaTagging === "100 Hari Kerja Walikota" ? 'bg-sky-500 text-white' : 'border-sky-500 text-sky-500'} rounded-lg hover:bg-sky-500 hover:text-white
                        `}
                    onClick={() => setNamaTagging("100 Hari Kerja Walikota")}
                >
                    <TbCircleCheckFilled />
                    100 Hari Kerja Walikota
                </button>
                <button
